...
<button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only blog-button" data-am-collapse="{target: '#blog-collapse'}" ><span class="am-sr-only">导航切换</span> <span class="am-icon-bars"></span></button>
  ...
  <div class="am-collapse am-topbar-collapse" id="blog-collapse">
    <ul class="am-nav am-nav-pills am-topbar-nav">
      ...
      <li><a href="lw-article.html">PHP</a></li>
      <li><a href="lw-article.html">LARAVEL</a></li>      
      <li><a href="lw-img.html">JAVASCRIPT</a></li>
      <li><a href="lw-article-fullwidth.html">MYSQL</a></li>
      <li><a href="lw-timeline.html">VUE</a></li>
      <li><a href="lw-timeline.html">杂笔</a></li>
    </ul>
...
<footer class="blog-footer">
    ...
    <div class="blog-text-center">Copyright© 2018. Kinross</<div>
...
<![endif]-->
<script src="{{ URL::asset('home/js/amazeui.min.js') }}"></script>
</body>
</html>